...
=======
Подсистема – часть системы, которую можно рассматривать как новую систему.
>>>>>>> 111ad1d59520dc138a8698389f62e16fa9d62976
### Связь 
...
### Модель состава
***Модель состава*** – это перечень подсистем и элементов, из которых состоит система,
с указанием отношения вложенности (иерархии).
### Пример можели состава
Объект – микрофон.\
Микрофон состоит из следующих составных частей: капсюль, схема усиления, соединяющий шнур, разъем, кнопка включения, 
источник питания, корпус, защитно-фильтрующая сетка.
![struct_model](./img/consistof_model.png)

## 2. Построить модель структуры для заданной системы. <a name="task2"></a> 

### Модель структуры 
В модели структуры (содержательная модель) описываются все элементы системы, 
все связи между элементами внутри системы и связи некоторых элементов с окружающей средой (входы и выходы системы),
указываются направления и типы связей (информационная, материальная, энергетическая). 
***Структура*** представляется как способ организации целого из составных частей.
### Пример модели структуры
Объект – микрофон.\
![struct_model](./img/struct_model.png)

## 3. Построить модель «черного ящика» для заданной системы. <a name="task3"></a> 

### Модель "чёрного ящика"
Во-первых, приведенное определение ничего не говорит о внутреннем устройстве системы.
Поэтому ее можно изобразить в виде непрозрачного «ящика», выделенного из окружающей среды. Подчеркнем, что уже эта,
максимально простая, модель по-своему отражает два следующих важных свойства системы: 
целостность и обособленность от среды.
### Пример модели "чёрного ящика"
![struct_model](./img/black_box_model.png)
